...
import "./MechaoDomain.sol";

/// @title Mechao Domain Factory
/// @author Oluwaseun-S
/// @notice Factory contract dynamically new domain contracts.
contract MechaoDomainFactoryV2 is IMechaoDomainFactory, ReentrancyGuard, Context{
  ...
  IMechaoDomainHub public domainHub;
  ...
  constructor(
    ...
    domainHub = IMechaoDomainHub(_domainHub);
  ...
  function _createTld(
   ...
   MechaoDomain tld = new MechaoDomain(
      _name, 
      _symbol, 
      _tldOwner, 
      _domainPrice, 
